    ...
    <div className="relative mx-4 sm:mx-8 lg:mx-10 min-h-[700px] overflow-hidden rounded-[32px] border border-[#24A8E0]/20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto h-full flex items-center px-6 lg:px-10">
        ...
        <div className="max-w-3xl">
          ...
          <button className="mt-12 px-10 py-4 rounded-full bg-[#F1CF45] text-black font-semibold hover:bg-[#24A8E0] hover:text-white transition">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="flex flex-wrap justify-center gap-10 py-8">
          ...
          {[
            ...
            <button
              key={item}
              className="text-gray-300 hover:text-[#F1CF45] transition font-medium tracking-wide"
            >
...
<div className="max-w-7xl mx-auto px-6 lg:px-10 mt-32">
  ...
  <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
    ...
    {technologies.map((tech, index) => (
      ...
      <div
        key={index}
        className="group bg-[#1A1D28] rounded-3xl overflow-hidden border border-white/10 hover:border-[#24A8E0] transition duration-500 hover:-translate-y-3"
      >
        ...
        <div className="p-8">
          ...
          <button className="mt-8 flex items-center gap-2 text-[#F1CF45] font-semibold group-hover:gap-4 transition-all">
  ...
  <div className="rounded-[35px] overflow-hidden bg-gradient-to-r from-[#15273C] via-[#1D416A] to-[#111015] border border-[#24A8E0]/20">
    ...
    <div className="grid lg:grid-cols-2 items-center">
      ...
      <div className="p-12 lg:p-16">
        ...
        <button className="mt-10 bg-[#F1CF45] text-black px-8 py-4 rounded-full font-semibold hover:bg-white transition flex items-center gap-3">
...
<div className="max-w-7xl mx-auto px-6 lg:px-10 py-28">
  ...
  <div className="rounded-[35px] bg-[#F1CF45] text-center px-10 py-20 shadow-2xl">
    ...
    <div className="flex flex-wrap justify-center gap-5 mt-12">
      ...
      <button className="bg-[#111015] text-white px-10 py-4 rounded-full font-semibold hover:bg-[#24A8E0] transition">

        Contact Us

      </button>

      <button className="border-2 border-[#111015] text-[#111015] px-10 py-4 rounded-full font-semibold hover:bg-[#111015] hover:text-white transition">
