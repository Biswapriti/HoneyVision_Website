...
const Products = () => {
  ...
  const [form, setForm] = useState({ title: "", slug: "", description: "", price: 0, images: [] });
  ...
  const resetForm = () => {
    setForm({ title: "", slug: "", description: "", price: 0, images: [] });
  ...
  const handleImageChange = (event) => {
    ...
    reader.onload = () => {
      ...
      setForm((prev) => ({ ...prev, images: [imageData] }));
  ...
  const editProduct = (product) => {
    ...
    setImagePreview(getProductImageUrl(product.slug));
    setError("");
  };
      ...
      <div className="rounded-3xl bg-[#0f1118] p-6">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          ...
          <textarea
            ...
            className="col-span-2 min-h-[120px] rounded-3xl border border-[#2f3a4a] bg-[#111015] px-4 py-3 text-white focus:border-[#24A8E0] focus:outline-none"
          />
        </div>

        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          <label className="block rounded-3xl border border-[#2f3a4a] bg-[#111015] p-4 text-sm text-white">
            <span className="block text-gray-400">Product image</span>
            <input
              type="file"
              accept="image/*"
                ...
                <div key={product._id} className="rounded-3xl border border-[#24A8E0]/10 bg-[#111015] p-4 shadow-sm">
                  <div className="grid gap-4 lg:grid-cols-[1fr_auto]">
                    ...
                    <div className="flex flex-col items-end gap-3">
                      <img src={getProductImageUrl(product.slug)} alt={product.title} className="h-24 w-24 rounded-3xl object-cover" />
