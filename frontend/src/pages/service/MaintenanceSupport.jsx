      ...
      <section className="py-24 px-6 lg:px-16">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-[#F1CF45] rounded-[40px] p-14 text-center">
            ...
            <button className="mt-10 bg-[#111015] text-white px-10 py-4 rounded-full font-semibold hover:bg-[#24A8E0] transition duration-300 flex items-center gap-3 mx-auto">
