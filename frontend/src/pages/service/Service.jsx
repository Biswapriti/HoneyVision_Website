...
const Service = () => {
  return (
    <>
      ...
      <section className="bg-[#111015] text-white">
        ...
        <section className="relative h-[75vh] overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto h-full flex items-center px-6">
            ...
            <div className="max-w-3xl">
              ...
              <button className="mt-10 bg-[#F1CF45] text-black px-8 py-4 rounded-full flex items-center gap-2 font-semibold hover:bg-[#24A8E0] hover:text-white transition">
        ...
        <section className="max-w-7xl mx-auto px-6 py-24">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
            ...
            {services.map((service, index) => (
              ...
              <div
                key={index}
                className="group rounded-3xl overflow-hidden bg-[#1D416A] hover:-translate-y-3 transition duration-300"
              >
    ...
    {services.map((service, index) => (
      ...
      >
        ...
        <div className="flex-1 p-8">
          ...
          <button className="mt-7 flex items-center gap-2 text-[#F1CF45] font-semibold hover:gap-4 transition-all">
            Learn More
            <ArrowRight size={18}/>
          </button>
  ...
  <div className="relative overflow-hidden rounded-[40px] bg-gradient-to-r from-[#24A8E0] via-[#1D416A] to-[#111015] p-14 lg:p-20">
    ...
    <div className="relative z-10 text-center">
      ...
      <div className="flex flex-wrap justify-center gap-6 mt-12">
        ...
        <button className="bg-[#F1CF45] text-black px-10 py-4 rounded-full font-semibold hover:bg-white transition duration-300">
          Request Consultation
        </button>

        <button className="border border-white px-10 py-4 rounded-full hover:bg-white hover:text-black transition duration-300">
          Contact Us
        </button>
