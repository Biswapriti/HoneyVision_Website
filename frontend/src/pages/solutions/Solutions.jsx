...
import aiSurveillance from "../../assets/solutions/AI Surveillance.jpg";
import aiSurveillance1 from "../../assets/solutions/AI Surveillance1.jpg";
import aiSurveillance2 from "../../assets/solutions/AI Surveillance2.jpg";
import smartarug from "../../assets/solutions/smartarug.jpg";
import smartarug1 from "../../assets/solutions/smartarug1.jpg";
import smartarug2 from "../../assets/solutions/smartarug2.jpg";
import smartcity from "../../assets/solutions/smartcity.jpg";
import computerVision from "../../assets/solutions/computervision.jpg";
  ...
  return (
    <>
      ...
      <section className="bg-[#111015] text-white pt-32 pb-24">
        ...
        <div className="solutions-page-shell max-w-6xl mx-auto px-6 lg:px-8">
    ...
    <div className="max-w-4xl mx-auto rounded-3xl border border-[#24A8E0]/20 bg-[#1D416A]/70 p-5 shadow-xl">
      <div className="overflow-hidden rounded-2xl aspect-video">
        <iframe
          ...
          src="https://youtu.be/m3br5SUWbl0?si=JFPZftofb73BWEtv"
